...
> **注意（2026-06-10）**：本文档已被超越，原"索引"部分由 [书籍索引系统.md](./书籍索引系统.md) 继承，
> "搜索"部分由 [书籍搜索系统.md](./书籍搜索系统.md) 独立成文。
> 两份新文档基于 codegraph 全量索引重写，补充了路径管理、迁移、resolver、unified、archive、
> vault 编译、tracer、Stage 6、跨书籍搜索、claim 验证等近半年新增能力，并补充测试覆盖地图。
> 本文档保留作为历史参考，不再更新。
