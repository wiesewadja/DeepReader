 ...
 * New code should import from '@/agent/prompts/core/formatter.js' instead.
 */

import { formatterPrompt } from '../../prompts/core/formatter.js';
...
export const PROMPT_S4_FORMATTER = formatterPrompt.locales.zh.systemPrompt;
