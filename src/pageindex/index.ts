/**
 * PageIndex v2.0 - Full API
 * Document indexing and Obsidian vault management
 *
 ...
 *
 * ⚠️  IMPORTANT: This entry point includes vault indexing features.
 *    For Node.js environments (Obsidian plugins), use './node.ts' instead.
 *
 * Runtime compatibility:
 *   - Full features available (vault indexing, search)
 *   - Node.js: Core features (PDF/EPUB parsing, TOC generation, export)
